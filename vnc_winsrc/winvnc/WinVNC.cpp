...
HINSTANCE	hAppInstance;//struct HINSTANCE__{int unused;}; typedef struct HINSTANCE__ *HINSTANCE
const char	*szAppName = "WinVNC";

DWORD		mainthreadId;//unsigned long

// WinMain parses the command line and either calls the main App
// routine or, under NT, the main service routine.
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)//__stdcall
{
#ifdef _DEBUG
	{
		// Get current flag
		int tmpFlag = _CrtSetDbgFlag( _CRTDBG_REPORT_FLAG );//current set debug flag
